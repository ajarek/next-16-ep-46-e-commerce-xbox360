...
export default function AdminPage() {
  ...
  const validateProductForm = (): boolean => {
    ...
    if (!newProduct.title.trim()) errors.title = "Nazwa produktu jest wymagana"
      ...
      errors.title = "Nazwa musi mieć co najmniej 3 znaki"
  ...
  const handleAddProduct = async (e: FormEvent) => {
    ...
    try {
      const price = parseFloat(newProduct.price)
      const discount = newProduct.discount.trim()
        ? parseInt(newProduct.discount, 10)
        : 0
      const stock = parseInt(newProduct.stock, 10)
      ...
      setProducts((prev) => [
        { ...productData, id: newId, createdAt: new Date().toISOString() },
        ...prev,
      ])
      setNewProduct({
        title: "",
      ...
      setProductFormErrors({
        submit: "Wystąpił błąd podczas dodawania produktu. Spróbuj ponownie.",
      })
    } finally {
  ...
  const validateEditForm = (): boolean => {
    ...
    if (!editFormData.description.trim())
      ...
      errors.description = "Min. 10 znaków"
    ...
    else if (!/^https?:\/\/.+/.test(editFormData.image.trim()))
      errors.image = "Prawidłowy URL"
  ...
  const handleSaveEdit = async (productId: string) => {
    ...
    try {
      const price = parseFloat(editFormData.price)
      const discount = editFormData.discount.trim()
        ? parseInt(editFormData.discount, 10)
        : 0
      const stock = parseInt(editFormData.stock, 10)
        ...
        <div className='flex items-center gap-2 overflow-x-auto pb-4 mb-8'>
          {[
            ...
            return (
              ...
              >
                <Icon
                  className={`w-4 h-4 ${isActive ? "text-xboxGreen" : ""}`}
                />
                <span>{tab.label}</span>
              </button>
            )
                  ...
                  {stats.map((stat, i) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <p
                          className={`font-orbitron font-extrabold text-2xl ${stat.color}`}
                        >
                          {stat.value}
                        </p>
                      </motion.div>
                    ...
                    >
                      ...
                      {order.promoCode && (
                        <p className='font-rajdhani text-xs text-xboxGreen font-bold'>
                          ...
                          {order.promoDiscount.toFixed(2)} PLN)
                        </p>
                      )}
                    </div>
                  ))
                  ...
                  >
                    ...
                    <div className='space-y-2'>
                      ...
                      {newProduct.image.trim() &&
                        /^https?:\/\/.+/.test(newProduct.image.trim()) && (
                          <div className='relative mt-2 w-full aspect-video rounded-xl overflow-hidden border border-white/10 bg-black/40'>
                            {/* eslint-disable-next-line @next/next/no-img-element */}
                            <img
                              src={
                                addImageFailed
                                  ? `https://images.unsplash.com/photo-1607604276583-eef5d076aa5f?w=600&auto=format&fit=crop&q=80&text=${encodeURIComponent(newProduct.title || "Podgląd")}`
                                  : newProduct.image.trim()
                              }
                    ...
                    <div className='flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 p-4 bg-white/5 border border-white/10 rounded-xl'>
                      ...
                      {newProduct.price && parseFloat(newProduct.price) > 0 && (
                        <div className='flex items-center gap-3'>
                          {newProduct.discount &&
                            parseInt(newProduct.discount, 10) > 0 && (
                          ...
                          <span className='font-orbitron font-bold text-lg text-neonCyan'>
                            {(
                              ...
                              (1 -
                                (parseInt(newProduct.discount, 10) || 0) / 100)
                            ).toFixed(2)}{" "}
                            PLN
                          </span>
                          {newProduct.discount &&
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className='space-y-1'>
                              ...
                              />
                              {editFormErrors.title && (
                                <p className='font-rajdhani text-[10px] text-red-400 font-semibold'>
                                  {editFormErrors.title}
                                </p>
                              )}
                            </div>
                                ...
                                /^https?:\/\/.+/.test(
                                  ...
                                  <div className='relative w-full aspect-video rounded-lg overflow-hidden border border-white/10 bg-black/40'>
                                    ...
                                    <img
                                      src={
                                        editImageFailed
                                          ? `https://images.unsplash.com/photo-1607604276583-eef5d076aa5f?w=600&auto=format&fit=crop&q=80&text=${encodeURIComponent(editFormData.title || "Podgląd")}`
                                          : editFormData.image.trim()
                                      }
                                      alt='Podgląd produktu'
                                      className='w-full h-full object-cover'
                              ...
                              parseFloat(editFormData.price) > 0 && (
                                <div className='flex items-center gap-2 text-xs font-rajdhani'>
                                  {editFormData.discount &&
                                    parseInt(editFormData.discount, 10) > 0 && (
                                      <span className='text-gray-500 line-through'>
                                        {parseFloat(editFormData.price).toFixed(
                                          2,
                                        )}{" "}
                                        PLN
                                      </span>
                      ...
                      {users.map((u) => (
                        ...
                        >
                          <div className='flex items-start justify-between'>
                            <div className='flex items-center gap-3'>
                              ...
                              <div>
                                ...
                                <p className='font-rajdhani text-xs text-gray-500 truncate max-w-40'>
                                  {u.email}
                                </p>
                              </div>
                            </div>
                          ...
                          <button
                            ...
                            disabled={
                              deletingUser === u.uid || u.role === "admin"
                            }
        ...
        <div className='fixed inset-0 z-50 flex items-center justify-center p-4'>
          ...
          >
            ...
            <p className='font-rajdhani text-sm text-gray-300 font-semibold'>
              ...
              <span className='text-white font-bold'>
                {" "}
                {confirmDeleteUser.displayName || "Gracz"}
              </span>
              <span className='text-gray-500'>
                {" "}
